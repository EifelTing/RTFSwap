...
from .fs_networks_fix import Generator_Adain_Upsample,Generator_Adain_Upsample_1_2_no_brance,Generator_Adain_Upsample_1_4_no_brance
...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        # Generator network
        self.netG = Generator_Adain_Upsample_1_4_no_brance(input_nc=3, output_nc=3, latent_size=512, n_blocks=9, deep=opt.Gdeep)
        self.netG.cuda()
        print(self.netG)
