...
# python train.py --name simswap224_test --batchSize 12  --gpu_ids 0 --dataset D:\Study_data\Test_2_lab\a_000_SimSwap_lab\images --Gdeep False
# nohup python train.py --name simswap224_test --batchSize 12 --gpu_ids 0 --dataset ./images --Gdeep True &

# python train.py --name simswap224_test --batchSize 1  --gpu_ids 0 --dataset ./images --Gdeep True

# 恢复训练
# python train.py --name simswap224_test --batchSize 12  --gpu_ids 0 --dataset ./images --Gdeep False --continue_train True --which_epoch 10000
